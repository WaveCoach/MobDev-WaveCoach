...
class ApiService extends GetConnect {
  ...
  Future<Response> getStyleSwim(int id) {
    return get("$url/assesment-category/$id", headers: getHeaders());
  }
  ...
  Future<Response> getDetailInventoryLanding(int landingId) {
    return get(
      "$url/inventory-landing/$landingId/detail",
      headers: getHeaders(),
    );
  }
  ...
  Future<Response> getCountNotification() {
    return get("$url/notification-count", headers: getHeaders());
  }
}
